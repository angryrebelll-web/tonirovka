...
// =========================================
const classMapping = {
    "sedan-small": 1,        // 1 класс (A-класс)
    "sedan-business": 2,      // 2 класс (C, E-класс)
    "sedan-premium": 2,       // 2 класс (C, E-класс)
    "sedan-luxury": 3,        // 3 класс (S-класс)
    "hatch-small": 1,        // 1 класс (A-класс)
    "hatch-medium": 2,        // 2 класс (C, E-класс)
    "coupe": 4,               // 4 класс (Спорткары)
    "coupe-sport": 4,        // 4 класс (Спорткары)
    "supercar": 4,           // 4 класс (Спорткары)
    "hypercar": 4,           // 4 класс (Спорткары)
    "luxury": 3,             // 3 класс (S-класс)
    "suv-compact": 3,        // 3 класс (Кроссоверы)
    "suv-medium": 3,         // 3 класс (Кроссоверы)
    "suv-large": 4,          // 4 класс (Внедорожники)
    "suv-luxury": 3,         // 3 класс (S-класс)
    "pickup-compact": 4,     // 4 класс (Внедорожники)
    "pickup-small": 4,       // 4 класс (Внедорожники)
    "pickup-medium": 4,      // 4 класс (Внедорожники)
    "pickup-large": 4,       // 4 класс (Внедорожники)
    "pickup-luxury": 4,      // 4 класс (Внедорожники)
    "minivan-compact": 3,    // 3 класс (Минивэны)
    "minivan-standard": 3,   // 3 класс (Минивэны)
    "minivan": 3,            // 3 класс (Минивэны)
    "minivan-business": 3,   // 3 класс (Минивэны)
    "minivan-premium": 3,    // 3 класс (Минивэны)
    "minivan-luxury": 3,     // 3 класс (Минивэны)
    "minivan-electric": 3,   // 3 класс (Минивэны)
    "minibus": 4,            // 4 класс (Микроавтобусы)
    "minibus-premium": 4,    // 4 класс (Микроавтобусы)
    "van-commercial": 4,     // 4 класс (Микроавтобусы)
    "cargo-medium": 4,       // 4 класс (Микроавтобусы)
    "cargo-large": 4         // 4 класс (Микроавтобусы)
};
